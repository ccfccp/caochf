...
public class Main {
    ...
    public static final String FILENAME = "F:\\workspaces\\myworkspaces\\voice\\16k-0.pcm"; //"F:\\其他\\qqDatas\\93766164\\FileRecv\\20210413_103531.m4a";//

    /**
     * MODE_FILE_STREAM为非实时流，如文件流，数据已经完整地在流中
     * MODE_SIMULATE_REAL_TIME_STREAM 为非实时流，用来生成模拟实时流
     */
//    private static final int MODE = Runner.MODE_SIMULATE_REAL_TIME_STREAM; //Runner.MODE_FILE_STREAM;  // 或 MODE_SIMULATE_REAL_TIME_STREAM
