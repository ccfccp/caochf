...
/**
 * @author caochf
 * @version 创建时间 2021年3月3日 下午16:37:26
 * <p>
 * 类描述：获取和判断文件头信息
...
//		System.out.println(builder.toString());
    ...
    public static void main(String[] args) throws Exception {
        String filePath = "D:\\temp\\桌面文档整理-20201204\\数据湖平台\\02 浪潮数据湖平台-数据服务产品白皮书-V3.0.docx";
        final String fileType = getFileType(new File(filePath));
        System.out.println(fileType);
        System.out.println(getFileHeader(new File(filePath)));
    }
}